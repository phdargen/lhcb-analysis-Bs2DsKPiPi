...
%	P(x,t,q_t,q_f) &\propto  [
	\frac{\Gamma(x,t,q,f)}{ e^{- \Gamma_s t} \, \text{d}t \, \text{d}\Phi_4} &\propto  
...
The static total decay amplitudes  $\mathcal A^c_{f}(\phsPoint)$  and $ \mathcal A^c_{f}(\phsPoint)$ 
...
\label{eq:PDF_intX}
	\nonumber
	\int \frac{\Gamma(x,t,q,f)}{e^{- \Gamma_s t} \, \text{d}t \,  \text{d}\Phi_4}  \, \text{d}\Phi_4 &\propto    
