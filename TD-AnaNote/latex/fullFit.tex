...
%In order to provide implementation-independent measurements in addition to the complex coefficients $a_i$, we define two quantities. 
The fit fractions
\begin{equation}
\label{eq:DefineFitFractions}
...
%Secondly, the interference fractions are given by
%\begin{equation}
