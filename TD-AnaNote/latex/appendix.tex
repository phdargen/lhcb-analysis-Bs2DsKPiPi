...
(up-left) different years of data-taking; (up-right) different data-taking periods;
(down-left) different $D_s$ final states; (down-right) different trigger categories. 
