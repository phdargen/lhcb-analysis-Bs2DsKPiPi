	...
	\begin{itemize}
		...
		\item Revisited some systematics
			\begin{itemize}
				...
				\item Instead of assuming pure phase space, recalculate running width of three-body resonances taking only the dominant $K\pi\pi$ decay mode into account (Sec.~\ref{ssec:lineshapeSys}) 
