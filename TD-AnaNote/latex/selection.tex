...
\begin{itemize}
\item DIRA $>$ 0.99994
\item min IP $\chi^{2}$ $<$ 16 to the PV,
\item FD $\chi^{2}$ $>$ 100 to the PV,
...
There difference between these two decay-times extends up to 0.1 ps, thus cutting at 0.4 ps avoids any boundary effects and simplifies the time-acceptance studies.
...
& & $> 0.5$ [Run-I,\textsf{L0-TIS}] \\
& & $> 0.35$ [Run-II,\textsf{L0-TOS}] \\
& & $> 0.5$ [Run-II,\textsf{L0-TIS}] \\
\\
