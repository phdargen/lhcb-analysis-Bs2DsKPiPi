...
\begin{enumerate}
	...
	\item $D^{*-} \to (\Dz\to\kaon\kaon) \pim$: \\
	%$\Dz$ combined with a random $\pion$ can fake a $\Ds\to\kaon\kaon\pion$ decay, 
	Same final state, vetoed by requiring $\left( M(KK\pim) - m(\kaon\kaon) \right) >  155 \mev$. 
\end{enumerate}
...
\begin{figure}[h]
\centering
\includegraphics[height=!,width=0.32\textwidth]{figs/BkgStudies/norm_Ds2KKpi_as_D02KK_compareVeto_2.pdf} 
\includegraphics[height=!,width=0.32\textwidth]{figs/BkgStudies/norm_Ds2pipipi_as_D02pipi_compareVeto_2.pdf} 
\includegraphics[height=!,width=0.32\textwidth]{figs/BkgStudies/norm_Ds2Kpipi_as_D02Kpi_compareVeto_2.pdf} 
\caption{Background contributions to $D_s^- \to KK\pi$ (left), $D_s^- \to \pi\pi\pi$ (middle) and $D_s^- \to K\pi\pi$ (right) from $D^{*-} \to (D^0\to hh) \pim$ decays. 
...
%& $p_T $ & $> 1600 \mev$\\
\\
$D_s^- \to K K \pi^-$  & $D^{*-}$ veto  & $m(KK\pim) - m(K K) > 155$ MeV \\
\\
...
& PIDp($\pi$) & $< 20$ \\
& $D^{*-}$ veto  & $m(\pi \pi \pim) - m(\pi \pi) > 155$ MeV \\
&  $\chi^{2}_{FD}$ & $> 9$ \\
&  FD in $z$  &$ > 0$ \\
\\
...
& PIDK($\pi$) & $< 5$ \\
& PIDp($\pi$) & $< 20$ \\
& $D^{*-}$ veto  & $m(K^- \pip \pim) - m(K^- \pip) > 155$ MeV \\
&  $\chi^{2}_{FD}$ & $> 9$ \\
&  FD in $z$  &$ > 0$ \\
...
In each case, the decay model includes a mixture of non-interfering resonances contributing to the 
$X_s \to K \pi \pi$ or $X_d \to \pi \pi \pi$ bachelor system and a non-resonant (phase-space) component.
...
$B_s \to (D_s \to K K \pi) K \pi\pi$  & 13266008  & 09c & Requested & Requested & Requested & Requested  & Generator Level, Stripping  \\
$B_s \to (D_s \to K \pi \pi) K \pi\pi$  & 13266058 & 09c  & Requested & Requested & Requested & Requested   & Generator Level, Stripping  \\
$B_s \to (D_s \to \pi \pi \pi) K \pi\pi$  & 13266038  & 09c &  Requested & Requested & Requested & Requested  & Generator Level, Stripping  \\
\\
$B_s \to (D_s \to K K \pi) \pi \pi\pi$  & 13266006 & 08i   & 1.2 M & 1.2 M & - & -   & Generator Level  \\
$B_s \to (D_s \to K K \pi) \pi \pi\pi$  & 13266068  & 09c & Requested & Requested & Requested & Requested   & Generator Level, Stripping  \\
$B_s \to (D_s \to K \pi \pi) \pi \pi\pi$  & 13266088  & 09c & Requested & Requested & Requested & Requested   & Generator Level, Stripping  \\
$B_s \to (D_s \to \pi \pi \pi) \pi \pi\pi$  & 13266078 & 09c  &Requested & Requested & Requested & Requested    & Generator Level, Stripping  \\
\\
