...
%The extracted calibration parameters and tagging asymmetries are summarized in Table \ref{table: OScalibration} and 
...
%\input{tables/Tagging/Run1/EspressoPerformanceTable.tex}
%\input{tables/Tagging/Run2/EspressoPerformanceTable.tex}
