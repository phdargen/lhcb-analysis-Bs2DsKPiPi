...
\hline
SS only& $(26.960\pm0.162)\%$    & $(1.416\pm0.017(\textrm{stat})\pm0.082(\textrm{cal}))\%$\\
OS only& $(21.561\pm0.150)\%$     & $(1.808\pm0.022(\textrm{stat})\pm0.100(\textrm{cal}))\%$\\
SS+OS& $(29.938\pm0.167)\%$ & $(3.498\pm0.033(\textrm{stat})\pm0.196(\textrm{cal}))\%$\\
\hline
total & & \\
\hline \hline
$\Bs\to\Ds\kaon\pion\pion$ &  \multicolumn{1}{c}{$\epsilon_{tag}$} & \multicolumn{1}{c}{$\epsilon_{eff}$} \\
\hline
SS only& $(26.945\pm0.928)\%$    & $(1.289\pm0.076(\textrm{stat})\pm0.076(\textrm{cal}))\%$\\
OS only& $(20.881\pm0.850)\%$     & $(1.665\pm0.107(\textrm{stat})\pm0.092(\textrm{cal}))\%$\\
SS+OS& $(30.192\pm0.960)\%$ & $(3.877\pm0.183(\textrm{stat})\pm0.219(\textrm{cal}))\%$\\
\hline
total & & \\
\end{tabular}
