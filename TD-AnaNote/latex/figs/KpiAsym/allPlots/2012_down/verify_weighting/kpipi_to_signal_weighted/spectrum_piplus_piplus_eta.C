...
//=========  (Thu Apr  5 16:04:37 2018) by ROOT version6.08/06
   TCanvas *c1_n2 = new TCanvas("c1_n2", "c1_n2",13,60,700,500);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   c1_n2->SetHighLightColor(2);
   c1_n2->Range(1.346914,-0.07936414,5.297531,0.4166617);
   ...
   kpipi_to_signal_pi_spectra_from_eta__7->SetBinContent(0,5.981912e-05);
   kpipi_to_signal_pi_spectra_from_eta__7->SetBinContent(1,0.04499566);
   kpipi_to_signal_pi_spectra_from_eta__7->SetBinContent(2,0.1426758);
   kpipi_to_signal_pi_spectra_from_eta__7->SetBinContent(3,0.2093677);
   kpipi_to_signal_pi_spectra_from_eta__7->SetBinContent(4,0.2799003);
   kpipi_to_signal_pi_spectra_from_eta__7->SetBinContent(5,0.2103186);
   kpipi_to_signal_pi_spectra_from_eta__7->SetBinContent(6,0.08910843);
   kpipi_to_signal_pi_spectra_from_eta__7->SetBinContent(7,0.02297968);
   kpipi_to_signal_pi_spectra_from_eta__7->SetBinContent(8,0.0006538248);
   kpipi_to_signal_pi_spectra_from_eta__7->SetBinContent(9,2.149393e-06);
   kpipi_to_signal_pi_spectra_from_eta__7->SetBinError(0,1.133003e-06);
   kpipi_to_signal_pi_spectra_from_eta__7->SetBinError(1,0.0001657772);
   kpipi_to_signal_pi_spectra_from_eta__7->SetBinError(2,0.0003851462);
   kpipi_to_signal_pi_spectra_from_eta__7->SetBinError(3,0.0002977211);
   kpipi_to_signal_pi_spectra_from_eta__7->SetBinError(4,0.0003757266);
   kpipi_to_signal_pi_spectra_from_eta__7->SetBinError(5,0.0004291274);
   kpipi_to_signal_pi_spectra_from_eta__7->SetBinError(6,0.0002471205);
   kpipi_to_signal_pi_spectra_from_eta__7->SetBinError(7,0.0001152515);
   kpipi_to_signal_pi_spectra_from_eta__7->SetBinError(8,2.052244e-05);
   kpipi_to_signal_pi_spectra_from_eta__7->SetBinError(9,9.909404e-07);
   kpipi_to_signal_pi_spectra_from_eta__7->SetMinimum(0);
   kpipi_to_signal_pi_spectra_from_eta__7->SetMaximum(0.3918604);
   ...
   kpipi_to_signal_pi_spectra_to_eta__8->SetBinContent(0,0.0008258458);
   kpipi_to_signal_pi_spectra_to_eta__8->SetBinContent(1,0.07845178);
   kpipi_to_signal_pi_spectra_to_eta__8->SetBinContent(2,0.1456264);
   kpipi_to_signal_pi_spectra_to_eta__8->SetBinContent(3,0.1757661);
   kpipi_to_signal_pi_spectra_to_eta__8->SetBinContent(4,0.2349361);
   kpipi_to_signal_pi_spectra_to_eta__8->SetBinContent(5,0.2242469);
   kpipi_to_signal_pi_spectra_to_eta__8->SetBinContent(6,0.09915988);
   kpipi_to_signal_pi_spectra_to_eta__8->SetBinContent(7,0.03652949);
   kpipi_to_signal_pi_spectra_to_eta__8->SetBinContent(8,0.005283274);
   kpipi_to_signal_pi_spectra_to_eta__8->SetBinError(0,0.0008258458);
   kpipi_to_signal_pi_spectra_to_eta__8->SetBinError(1,0.01282191);
   kpipi_to_signal_pi_spectra_to_eta__8->SetBinError(2,0.02623828);
   kpipi_to_signal_pi_spectra_to_eta__8->SetBinError(3,0.0265818);
   kpipi_to_signal_pi_spectra_to_eta__8->SetBinError(4,0.03042954);
   kpipi_to_signal_pi_spectra_to_eta__8->SetBinError(5,0.03578186);
   kpipi_to_signal_pi_spectra_to_eta__8->SetBinError(6,0.02337481);
   kpipi_to_signal_pi_spectra_to_eta__8->SetBinError(7,0.00935896);
   kpipi_to_signal_pi_spectra_to_eta__8->SetBinError(8,0.003087473);
   kpipi_to_signal_pi_spectra_to_eta__8->SetEntries(2734);
