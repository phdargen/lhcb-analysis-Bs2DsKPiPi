...
//=========  (Thu Apr  5 14:48:52 2018) by ROOT version6.08/06
   TCanvas *c1_n2 = new TCanvas("c1_n2", "c1_n2",13,60,700,500);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   c1_n2->SetHighLightColor(2);
   c1_n2->Range(1.346914,-0.07676864,5.297531,0.4030354);
   ...
   kpipi_to_signal_k_spectra_from_eta__3->SetBinContent(0,4.155104e-06);
   kpipi_to_signal_k_spectra_from_eta__3->SetBinContent(1,0.02289092);
   kpipi_to_signal_k_spectra_from_eta__3->SetBinContent(2,0.129251);
   kpipi_to_signal_k_spectra_from_eta__3->SetBinContent(3,0.2491291);
   kpipi_to_signal_k_spectra_from_eta__3->SetBinContent(4,0.2707466);
   kpipi_to_signal_k_spectra_from_eta__3->SetBinContent(5,0.1968964);
   kpipi_to_signal_k_spectra_from_eta__3->SetBinContent(6,0.09523883);
   kpipi_to_signal_k_spectra_from_eta__3->SetBinContent(7,0.03518391);
   kpipi_to_signal_k_spectra_from_eta__3->SetBinContent(8,0.0006632834);
   kpipi_to_signal_k_spectra_from_eta__3->SetBinContent(9,7.469963e-07);
   kpipi_to_signal_k_spectra_from_eta__3->SetBinError(0,5.924159e-07);
   kpipi_to_signal_k_spectra_from_eta__3->SetBinError(1,0.0001641664);
   kpipi_to_signal_k_spectra_from_eta__3->SetBinError(2,0.0005500191);
   kpipi_to_signal_k_spectra_from_eta__3->SetBinError(3,0.000595989);
   kpipi_to_signal_k_spectra_from_eta__3->SetBinError(4,0.0006335411);
   kpipi_to_signal_k_spectra_from_eta__3->SetBinError(5,0.0006296687);
   kpipi_to_signal_k_spectra_from_eta__3->SetBinError(6,0.0003377122);
   kpipi_to_signal_k_spectra_from_eta__3->SetBinError(7,0.0001715922);
   kpipi_to_signal_k_spectra_from_eta__3->SetBinError(8,1.416836e-05);
   kpipi_to_signal_k_spectra_from_eta__3->SetBinError(9,1.212331e-07);
   kpipi_to_signal_k_spectra_from_eta__3->SetMinimum(0);
   kpipi_to_signal_k_spectra_from_eta__3->SetMaximum(0.3790452);
   ...
   kpipi_to_signal_k_spectra_to_eta__4->SetBinContent(1,0.04623688);
   kpipi_to_signal_k_spectra_to_eta__4->SetBinContent(2,0.1699769);
   kpipi_to_signal_k_spectra_to_eta__4->SetBinContent(3,0.2389003);
   kpipi_to_signal_k_spectra_to_eta__4->SetBinContent(4,0.2260742);
   kpipi_to_signal_k_spectra_to_eta__4->SetBinContent(5,0.1974437);
   kpipi_to_signal_k_spectra_to_eta__4->SetBinContent(6,0.06132037);
   kpipi_to_signal_k_spectra_to_eta__4->SetBinContent(7,0.05767438);
   kpipi_to_signal_k_spectra_to_eta__4->SetBinContent(8,0.002373189);
   kpipi_to_signal_k_spectra_to_eta__4->SetBinError(1,0.01788274);
   kpipi_to_signal_k_spectra_to_eta__4->SetBinError(2,0.04858919);
   kpipi_to_signal_k_spectra_to_eta__4->SetBinError(3,0.05072692);
   kpipi_to_signal_k_spectra_to_eta__4->SetBinError(4,0.05201684);
   kpipi_to_signal_k_spectra_to_eta__4->SetBinError(5,0.05541627);
   kpipi_to_signal_k_spectra_to_eta__4->SetBinError(6,0.03882236);
   kpipi_to_signal_k_spectra_to_eta__4->SetBinError(7,0.01805424);
   kpipi_to_signal_k_spectra_to_eta__4->SetBinError(8,0.003555657);
   kpipi_to_signal_k_spectra_to_eta__4->SetEntries(1022);
