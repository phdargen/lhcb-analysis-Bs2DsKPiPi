...
% Authors -------------------------------------------------
\begin{center}
P. d'Argent$^1$, E. Gersabeck$^2$, M. Kecke$^1$, M. Schiller$^2$
\bigskip\\
...
\begin{abstract}
  \noindent
We present the first measurement of the weak phase $2\beta + \gamma$ obtained from a time-dependent (amplitude) analysis of 
$\Bs \to \Ds K \pi \pi$ decays using 
proton-proton collision data corresponding to an integrated luminosity of \textcolor{red}{xxx} $\invfb$ recorded by the LHCb detector.
