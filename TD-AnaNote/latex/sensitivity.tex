...
Assumptions:
	...
	\end{itemize}
		...
		\begin{figure}[hp]
	\centering
		\includegraphics[width=0.45\textwidth, height = !]{plots_toy/h_t.eps} 
		\includegraphics[width=0.45\textwidth, height = !]{plots_toy/s_Dspipi.eps} 
		
		\includegraphics[width=0.45\textwidth, height = !]{plots_toy/s_DsK.eps} 
		\includegraphics[width=0.45\textwidth, height = !]{plots_toy/s_Kpipi.eps}
		 
		\includegraphics[width=0.45\textwidth, height = !]{plots_toy/s_Kpi.eps} 
		\includegraphics[width=0.45\textwidth, height = !]{plots_toy/s_pipi.eps}
...
%		\includegraphics[width=0.4\textwidth, height = 4 cm]{plots/LL_scan_p.eps} 
		...
		\includegraphics[width=0.45\textwidth, height = 4 cm]{plots/LL_scan.eps} 
