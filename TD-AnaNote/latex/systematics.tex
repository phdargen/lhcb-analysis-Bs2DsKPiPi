...
The fit results of the following alternative models (Alt.~1 - Alt.~15) are summarized in Tables~\ref{tab:altModels} and \ref{tab:altModels2}.

\begin{itemize}
\small
	\item All amplitudes selected by Stage 1 of the model selection are included for both $b\to c$ and $b\to u$ transitions (Alt.~1)
				
	\item The decay channels $K_1(1270)[D] \to K^*(892) \, \pi$, where the $K^*(892) \, \pi$ system is in relative a D-wave state,
	and $K_1(1400) \to K \, \rho(1450)$ are added (Alt.~2)

	\item The decay channel $K_1(1400) \to K \, \rho(770)$ is added (Alt.~15)
...
\begin{table}[h]
\centering
\caption{Fit fractions in percent for the baseline and several alternative amplitude models (Alt. 1 - Alt. 7). 
...
\begin{table}[h]
\centering
\caption{Fit fractions in percent for several alternative amplitude models (Alt. 8 - Alt. 15). 
Resonance parameters and the physical observables $r, \kappa, \delta, \gamma - 2 \beta_s$ are also given.
The values of the physical observables are given relative to the baseline result.
The uncertainties are statistical only.}
\resizebox{1.05\linewidth}{!}{
