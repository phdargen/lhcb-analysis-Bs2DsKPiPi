...
%	\item The amplitudes $B_s \to (D_s \, \pi)_{P} \, K^{*}(892)$ and $B_s \to (D_s \, K)_{P} \, \rho(770)$ are removed (Alt.~14 and Alt.~13)
	...
	\item The old baseline model obtained with 2011-2017 data and a bug in the pdf (see v7.0 of the note) (Alt.~12)
	
	\item The amplitude $B_s \to (D_s \, K)_{P} \, \rho(770)$ is removed (Alt.~13)
...
From the remaining 13 models, we compute the sample variance for each observable and take it as model uncertainty.
