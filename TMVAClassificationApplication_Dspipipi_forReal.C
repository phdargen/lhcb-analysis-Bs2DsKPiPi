...
{   
   ...
   theTree->Add("/auto/data/kecke/B2DPiPiPi/Data2012/data2012_Ds2pipipi_forBDT.root");
   ...
   TFile *hFile = new TFile("/auto/data/kecke/B2DPiPiPi/Data2012/data12_Ds2pipipi_BDT.root","RECREATE");
...
*/
   ...
   theTree->SetBranchAddress( "pi_plus_fromDs_ETA", &myVar18 );
   theTree->SetBranchAddress( "pi_minus2_fromDs_ETA", &myVar19 );
   ...
   theTree->SetBranchAddress( "pi_plus_fromDs_ptasy_1.00", &myVar26 );
   theTree->SetBranchAddress( "pi_minus2_fromDs_ptasy_1.00", &myVar27 );
   ...
   theTree->SetBranchAddress( "pi_plus_fromDs_TRACK_GhostProb", &myVar32 );
   theTree->SetBranchAddress( "pi_minus2_fromDs_TRACK_GhostProb", &myVar33 );
