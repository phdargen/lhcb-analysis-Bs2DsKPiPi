#define MCDecayTreeTuple_Ds3pi_KKpi_cxx
#include "MCDecayTreeTuple_Ds3pi_KKpi.h"
#include <TH2.h>
#include <TStyle.h>
#include <TCanvas.h>
#include <algorithm>

void MCDecayTreeTuple_Ds3pi_KKpi::Loop()
{

   if (fChain == 0) return;

    TFile* output = new TFile("Gen_Ds3pi_KKpi.root","RECREATE");
   ...
   for (Long64_t jentry=0; jentry<nentries;jentry++) {
      ...
      fChain->GetEntry(jentry);   
       ...
       K_plus.SetXYZM(piplus_TRUEP_X,piplus_TRUEP_Y,piplus_TRUEP_Z,massPion);
       pi_minus.SetXYZM(piminus_TRUEP_X,piminus_TRUEP_Y,piminus_TRUEP_Z,massPion);
       pi_plus.SetXYZM(piplus0_TRUEP_X,piplus0_TRUEP_Y,piplus0_TRUEP_Z,massPion);   
      
       pi_minus_fromDs.SetXYZM(piminus0_TRUEP_X,piminus0_TRUEP_Y,piminus0_TRUEP_Z,massPion);        
       K_plus_fromDs.SetXYZM(Kplus_TRUEP_X,Kplus_TRUEP_Y,Kplus_TRUEP_Z,massKaon);
       K_minus_fromDs.SetXYZM(Kminus_TRUEP_X,Kminus_TRUEP_Y,Kminus_TRUEP_Z,massKaon);
       ...
       Ds_SumPT = Kminus_TRUEPT + piminus0_TRUEPT +  Kplus_TRUEPT ;
       Xs_SumPT = piminus_TRUEPT + piplus_TRUEPT +  piplus0_TRUEPT ;
