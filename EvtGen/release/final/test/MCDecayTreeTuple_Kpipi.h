...
// Sat Nov 18 20:20:01 2017 by ROOT version 5.34/10
// from TTree MCDecayTree/MCDecayTree
// found on file: /auto/data/dargent/BsDsKpipi/EvtGen/Gen_test_DsKpipi,Kpipi.root
//////////////////////////////////////////////////////////

#ifndef MCDecayTreeTuple_Kpipi_h
#define MCDecayTreeTuple_Kpipi_h
...
public :
   ...
   MCDecayTreeTuple_Kpipi(TString tuple = "GenMC.root");
   virtual ~MCDecayTreeTuple_Kpipi();
...
#ifdef MCDecayTreeTuple_Kpipi_cxx
MCDecayTreeTuple_Kpipi::MCDecayTreeTuple_Kpipi(TString tuple ) : fChain(0) 
{
...
MCDecayTreeTuple_Kpipi::~MCDecayTreeTuple_Kpipi()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t MCDecayTreeTuple_Kpipi::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t MCDecayTreeTuple_Kpipi::LoadTree(Long64_t entry)
{
...
void MCDecayTreeTuple_Kpipi::Init(TTree *tree)
{
...
Bool_t MCDecayTreeTuple_Kpipi::Notify()
{
...
void MCDecayTreeTuple_Kpipi::Show(Long64_t entry)
{
...
Int_t MCDecayTreeTuple_Kpipi::Cut(Long64_t entry)
{
...
#endif // #ifdef MCDecayTreeTuple_Kpipi_cxx
