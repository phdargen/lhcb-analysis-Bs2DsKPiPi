...
// Sat Nov 18 20:19:27 2017 by ROOT version 5.34/10
// from TTree MCDecayTree/MCDecayTree
// found on file: /auto/data/dargent/BsDsKpipi/EvtGen/Gen_test_DsKpipi,pipipi.root
//////////////////////////////////////////////////////////

#ifndef MCDecayTreeTuple_pipipi_h
#define MCDecayTreeTuple_pipipi_h
...
public :
   ...
   Double_t        piplus0_nPhotos;
   Double_t        piplus0_TRUEID;
   Int_t           piplus0_MC_MOTHER_ID;
   Int_t           piplus0_MC_MOTHER_KEY;
   Int_t           piplus0_MC_GD_MOTHER_ID;
   Int_t           piplus0_MC_GD_MOTHER_KEY;
   Int_t           piplus0_MC_GD_GD_MOTHER_ID;
   Int_t           piplus0_MC_GD_GD_MOTHER_KEY;
   Double_t        piplus0_TRUEP_E;
   Double_t        piplus0_TRUEP_X;
   Double_t        piplus0_TRUEP_Y;
   Double_t        piplus0_TRUEP_Z;
   Double_t        piplus0_TRUEPT;
   Double_t        piplus0_TRUEORIGINVERTEX_X;
   Double_t        piplus0_TRUEORIGINVERTEX_Y;
   Double_t        piplus0_TRUEORIGINVERTEX_Z;
   Double_t        piplus0_TRUEENDVERTEX_X;
   Double_t        piplus0_TRUEENDVERTEX_Y;
   Double_t        piplus0_TRUEENDVERTEX_Z;
   Bool_t          piplus0_TRUEISSTABLE;
   Double_t        piplus0_TRUETAU;
   Bool_t          piplus0_OSCIL;
   ...
   Double_t        piminus1_nPhotos;
   Double_t        piminus1_TRUEID;
   Int_t           piminus1_MC_MOTHER_ID;
   Int_t           piminus1_MC_MOTHER_KEY;
   Int_t           piminus1_MC_GD_MOTHER_ID;
   Int_t           piminus1_MC_GD_MOTHER_KEY;
   Int_t           piminus1_MC_GD_GD_MOTHER_ID;
   Int_t           piminus1_MC_GD_GD_MOTHER_KEY;
   Double_t        piminus1_TRUEP_E;
   Double_t        piminus1_TRUEP_X;
   Double_t        piminus1_TRUEP_Y;
   Double_t        piminus1_TRUEP_Z;
   Double_t        piminus1_TRUEPT;
   Double_t        piminus1_TRUEORIGINVERTEX_X;
   Double_t        piminus1_TRUEORIGINVERTEX_Y;
   Double_t        piminus1_TRUEORIGINVERTEX_Z;
   Double_t        piminus1_TRUEENDVERTEX_X;
   Double_t        piminus1_TRUEENDVERTEX_Y;
   Double_t        piminus1_TRUEENDVERTEX_Z;
   Bool_t          piminus1_TRUEISSTABLE;
   Double_t        piminus1_TRUETAU;
   Bool_t          piminus1_OSCIL;
   UInt_t          nCandidate;
   ...
   TBranch        *b_piplus0_nPhotos;   //!
   TBranch        *b_piplus0_TRUEID;   //!
   TBranch        *b_piplus0_MC_MOTHER_ID;   //!
   TBranch        *b_piplus0_MC_MOTHER_KEY;   //!
   TBranch        *b_piplus0_MC_GD_MOTHER_ID;   //!
   TBranch        *b_piplus0_MC_GD_MOTHER_KEY;   //!
   TBranch        *b_piplus0_MC_GD_GD_MOTHER_ID;   //!
   TBranch        *b_piplus0_MC_GD_GD_MOTHER_KEY;   //!
   TBranch        *b_piplus0_TRUEP_E;   //!
   TBranch        *b_piplus0_TRUEP_X;   //!
   TBranch        *b_piplus0_TRUEP_Y;   //!
   TBranch        *b_piplus0_TRUEP_Z;   //!
   TBranch        *b_piplus0_TRUEPT;   //!
   TBranch        *b_piplus0_TRUEORIGINVERTEX_X;   //!
   TBranch        *b_piplus0_TRUEORIGINVERTEX_Y;   //!
   TBranch        *b_piplus0_TRUEORIGINVERTEX_Z;   //!
   TBranch        *b_piplus0_TRUEENDVERTEX_X;   //!
   TBranch        *b_piplus0_TRUEENDVERTEX_Y;   //!
   TBranch        *b_piplus0_TRUEENDVERTEX_Z;   //!
   TBranch        *b_piplus0_TRUEISSTABLE;   //!
   TBranch        *b_piplus0_TRUETAU;   //!
   TBranch        *b_piplus0_OSCIL;   //!
   ...
   TBranch        *b_piminus1_nPhotos;   //!
   TBranch        *b_piminus1_TRUEID;   //!
   TBranch        *b_piminus1_MC_MOTHER_ID;   //!
   TBranch        *b_piminus1_MC_MOTHER_KEY;   //!
   TBranch        *b_piminus1_MC_GD_MOTHER_ID;   //!
   TBranch        *b_piminus1_MC_GD_MOTHER_KEY;   //!
   TBranch        *b_piminus1_MC_GD_GD_MOTHER_ID;   //!
   TBranch        *b_piminus1_MC_GD_GD_MOTHER_KEY;   //!
   TBranch        *b_piminus1_TRUEP_E;   //!
   TBranch        *b_piminus1_TRUEP_X;   //!
   TBranch        *b_piminus1_TRUEP_Y;   //!
   TBranch        *b_piminus1_TRUEP_Z;   //!
   TBranch        *b_piminus1_TRUEPT;   //!
   TBranch        *b_piminus1_TRUEORIGINVERTEX_X;   //!
   TBranch        *b_piminus1_TRUEORIGINVERTEX_Y;   //!
   TBranch        *b_piminus1_TRUEORIGINVERTEX_Z;   //!
   TBranch        *b_piminus1_TRUEENDVERTEX_X;   //!
   TBranch        *b_piminus1_TRUEENDVERTEX_Y;   //!
   TBranch        *b_piminus1_TRUEENDVERTEX_Z;   //!
   TBranch        *b_piminus1_TRUEISSTABLE;   //!
   TBranch        *b_piminus1_TRUETAU;   //!
   TBranch        *b_piminus1_OSCIL;   //!
   TBranch        *b_nCandidate;   //!
   TBranch        *b_totCandidates;   //!
   TBranch        *b_EventInSequence;   //!

   MCDecayTreeTuple_pipipi(TString tuple = "GenMC.root");
   virtual ~MCDecayTreeTuple_pipipi();
...
#ifdef MCDecayTreeTuple_pipipi_cxx
MCDecayTreeTuple_pipipi::MCDecayTreeTuple_pipipi(TString tuple ) : fChain(0) 
{
...
MCDecayTreeTuple_pipipi::~MCDecayTreeTuple_pipipi()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t MCDecayTreeTuple_pipipi::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t MCDecayTreeTuple_pipipi::LoadTree(Long64_t entry)
{
...
void MCDecayTreeTuple_pipipi::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("piplus0_nPhotos", &piplus0_nPhotos, &b_piplus0_nPhotos);
   fChain->SetBranchAddress("piplus0_TRUEID", &piplus0_TRUEID, &b_piplus0_TRUEID);
   fChain->SetBranchAddress("piplus0_MC_MOTHER_ID", &piplus0_MC_MOTHER_ID, &b_piplus0_MC_MOTHER_ID);
   fChain->SetBranchAddress("piplus0_MC_MOTHER_KEY", &piplus0_MC_MOTHER_KEY, &b_piplus0_MC_MOTHER_KEY);
   fChain->SetBranchAddress("piplus0_MC_GD_MOTHER_ID", &piplus0_MC_GD_MOTHER_ID, &b_piplus0_MC_GD_MOTHER_ID);
   fChain->SetBranchAddress("piplus0_MC_GD_MOTHER_KEY", &piplus0_MC_GD_MOTHER_KEY, &b_piplus0_MC_GD_MOTHER_KEY);
   fChain->SetBranchAddress("piplus0_MC_GD_GD_MOTHER_ID", &piplus0_MC_GD_GD_MOTHER_ID, &b_piplus0_MC_GD_GD_MOTHER_ID);
   fChain->SetBranchAddress("piplus0_MC_GD_GD_MOTHER_KEY", &piplus0_MC_GD_GD_MOTHER_KEY, &b_piplus0_MC_GD_GD_MOTHER_KEY);
   fChain->SetBranchAddress("piplus0_TRUEP_E", &piplus0_TRUEP_E, &b_piplus0_TRUEP_E);
   fChain->SetBranchAddress("piplus0_TRUEP_X", &piplus0_TRUEP_X, &b_piplus0_TRUEP_X);
   fChain->SetBranchAddress("piplus0_TRUEP_Y", &piplus0_TRUEP_Y, &b_piplus0_TRUEP_Y);
   fChain->SetBranchAddress("piplus0_TRUEP_Z", &piplus0_TRUEP_Z, &b_piplus0_TRUEP_Z);
   fChain->SetBranchAddress("piplus0_TRUEPT", &piplus0_TRUEPT, &b_piplus0_TRUEPT);
   fChain->SetBranchAddress("piplus0_TRUEORIGINVERTEX_X", &piplus0_TRUEORIGINVERTEX_X, &b_piplus0_TRUEORIGINVERTEX_X);
   fChain->SetBranchAddress("piplus0_TRUEORIGINVERTEX_Y", &piplus0_TRUEORIGINVERTEX_Y, &b_piplus0_TRUEORIGINVERTEX_Y);
   fChain->SetBranchAddress("piplus0_TRUEORIGINVERTEX_Z", &piplus0_TRUEORIGINVERTEX_Z, &b_piplus0_TRUEORIGINVERTEX_Z);
   fChain->SetBranchAddress("piplus0_TRUEENDVERTEX_X", &piplus0_TRUEENDVERTEX_X, &b_piplus0_TRUEENDVERTEX_X);
   fChain->SetBranchAddress("piplus0_TRUEENDVERTEX_Y", &piplus0_TRUEENDVERTEX_Y, &b_piplus0_TRUEENDVERTEX_Y);
   fChain->SetBranchAddress("piplus0_TRUEENDVERTEX_Z", &piplus0_TRUEENDVERTEX_Z, &b_piplus0_TRUEENDVERTEX_Z);
   fChain->SetBranchAddress("piplus0_TRUEISSTABLE", &piplus0_TRUEISSTABLE, &b_piplus0_TRUEISSTABLE);
   fChain->SetBranchAddress("piplus0_TRUETAU", &piplus0_TRUETAU, &b_piplus0_TRUETAU);
   fChain->SetBranchAddress("piplus0_OSCIL", &piplus0_OSCIL, &b_piplus0_OSCIL);
   ...
   fChain->SetBranchAddress("piminus1_nPhotos", &piminus1_nPhotos, &b_piminus1_nPhotos);
   fChain->SetBranchAddress("piminus1_TRUEID", &piminus1_TRUEID, &b_piminus1_TRUEID);
   fChain->SetBranchAddress("piminus1_MC_MOTHER_ID", &piminus1_MC_MOTHER_ID, &b_piminus1_MC_MOTHER_ID);
   fChain->SetBranchAddress("piminus1_MC_MOTHER_KEY", &piminus1_MC_MOTHER_KEY, &b_piminus1_MC_MOTHER_KEY);
   fChain->SetBranchAddress("piminus1_MC_GD_MOTHER_ID", &piminus1_MC_GD_MOTHER_ID, &b_piminus1_MC_GD_MOTHER_ID);
   fChain->SetBranchAddress("piminus1_MC_GD_MOTHER_KEY", &piminus1_MC_GD_MOTHER_KEY, &b_piminus1_MC_GD_MOTHER_KEY);
   fChain->SetBranchAddress("piminus1_MC_GD_GD_MOTHER_ID", &piminus1_MC_GD_GD_MOTHER_ID, &b_piminus1_MC_GD_GD_MOTHER_ID);
   fChain->SetBranchAddress("piminus1_MC_GD_GD_MOTHER_KEY", &piminus1_MC_GD_GD_MOTHER_KEY, &b_piminus1_MC_GD_GD_MOTHER_KEY);
   fChain->SetBranchAddress("piminus1_TRUEP_E", &piminus1_TRUEP_E, &b_piminus1_TRUEP_E);
   fChain->SetBranchAddress("piminus1_TRUEP_X", &piminus1_TRUEP_X, &b_piminus1_TRUEP_X);
   fChain->SetBranchAddress("piminus1_TRUEP_Y", &piminus1_TRUEP_Y, &b_piminus1_TRUEP_Y);
   fChain->SetBranchAddress("piminus1_TRUEP_Z", &piminus1_TRUEP_Z, &b_piminus1_TRUEP_Z);
   fChain->SetBranchAddress("piminus1_TRUEPT", &piminus1_TRUEPT, &b_piminus1_TRUEPT);
   fChain->SetBranchAddress("piminus1_TRUEORIGINVERTEX_X", &piminus1_TRUEORIGINVERTEX_X, &b_piminus1_TRUEORIGINVERTEX_X);
   fChain->SetBranchAddress("piminus1_TRUEORIGINVERTEX_Y", &piminus1_TRUEORIGINVERTEX_Y, &b_piminus1_TRUEORIGINVERTEX_Y);
   fChain->SetBranchAddress("piminus1_TRUEORIGINVERTEX_Z", &piminus1_TRUEORIGINVERTEX_Z, &b_piminus1_TRUEORIGINVERTEX_Z);
   fChain->SetBranchAddress("piminus1_TRUEENDVERTEX_X", &piminus1_TRUEENDVERTEX_X, &b_piminus1_TRUEENDVERTEX_X);
   fChain->SetBranchAddress("piminus1_TRUEENDVERTEX_Y", &piminus1_TRUEENDVERTEX_Y, &b_piminus1_TRUEENDVERTEX_Y);
   fChain->SetBranchAddress("piminus1_TRUEENDVERTEX_Z", &piminus1_TRUEENDVERTEX_Z, &b_piminus1_TRUEENDVERTEX_Z);
   fChain->SetBranchAddress("piminus1_TRUEISSTABLE", &piminus1_TRUEISSTABLE, &b_piminus1_TRUEISSTABLE);
   fChain->SetBranchAddress("piminus1_TRUETAU", &piminus1_TRUETAU, &b_piminus1_TRUETAU);
   fChain->SetBranchAddress("piminus1_OSCIL", &piminus1_OSCIL, &b_piminus1_OSCIL);
...
Bool_t MCDecayTreeTuple_pipipi::Notify()
{
...
void MCDecayTreeTuple_pipipi::Show(Long64_t entry)
{
...
Int_t MCDecayTreeTuple_pipipi::Cut(Long64_t entry)
{
...
#endif // #ifdef MCDecayTreeTuple_pipipi_cxx
