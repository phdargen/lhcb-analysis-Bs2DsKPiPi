...
void MCDecayTreeTuple::Loop()
{

   if (fChain == 0) return;

    TFile* output = new TFile("GenMC_KKpi.root","RECREATE");
   ...
   for (Long64_t jentry=0; jentry<nentries;jentry++) {
      ...
      fChain->GetEntry(jentry);   
       ...
       K_plus_fromDs.SetXYZM(Kplus0_TRUEP_X,Kplus0_TRUEP_Y,Kplus0_TRUEP_Z,massKaon);
       ...
       Ds_SumPT = Kminus_TRUEPT + piminus0_TRUEPT +  Kplus0_TRUEPT ;
