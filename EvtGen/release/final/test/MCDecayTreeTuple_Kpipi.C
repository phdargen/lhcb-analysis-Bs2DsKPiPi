#define MCDecayTreeTuple_Kpipi_cxx
#include "MCDecayTreeTuple_Kpipi.h"
#include <TH2.h>
#include <TStyle.h>
#include <TCanvas.h>
#include <algorithm>

void MCDecayTreeTuple_Kpipi::Loop()
{

   if (fChain == 0) return;

    TFile* output = new TFile("Gen_Kpipi.root","RECREATE");
   ...
   for (Long64_t jentry=0; jentry<nentries;jentry++) {
      ...
      fChain->GetEntry(jentry);   
       ...
       Ds_SumPT = Kminus_TRUEPT + piminus0_TRUEPT +  piplus0_TRUEPT ;
