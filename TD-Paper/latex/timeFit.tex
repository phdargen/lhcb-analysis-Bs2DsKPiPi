...
The fit to the decay-time distribution is shown in Figure \ref{fig:tFitNorm} and the mixing frequency is measured to be %the measured observables are summarized in Table \ref{tab:normFitResults}. 
