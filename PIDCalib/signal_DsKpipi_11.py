...
files = [
  ...
  (indir+"signal_Ds2Kpipi_11.root",          "signal_Ds2Kpipi_11_PID_tmp.root",  "MagDown_2011", "gen_MagDown",trackList[2],"Gen"), 
  ("signal_Ds2Kpipi_11_PID_tmp.root", "signal_Ds2Kpipi_11_PID_tmp2.root", "MagDown_2011", "corr_MagDown",trackList[2],"Corr"), 
  ("signal_Ds2Kpipi_11_PID_tmp2.root", "signal_Ds2Kpipi_11_PID.root",      "MagUp_2011",   "corr_MagUp",  trackList[2],"Corr"),
