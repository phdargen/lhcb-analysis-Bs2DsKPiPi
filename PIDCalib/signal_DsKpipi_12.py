...
files = [
  ...
  (indir+"signal_Ds2Kpipi_12.root",          "signal_Ds2Kpipi_12_PID_tmp.root",  "MagDown_2012", "gen_MagDown",trackList[2],"Gen"), 
  ("signal_Ds2Kpipi_12_PID_tmp.root", "signal_Ds2Kpipi_12_PID_tmp2.root", "MagDown_2012", "corr_MagDown",trackList[2],"Corr"), 
  ("signal_Ds2Kpipi_12_PID_tmp2.root", "signal_Ds2Kpipi_12_PID.root",      "MagUp_2012",   "corr_MagUp",  trackList[2],"Corr"),
