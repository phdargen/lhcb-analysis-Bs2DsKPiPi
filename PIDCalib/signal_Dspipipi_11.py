...
files = [
  ...
  (indir+"signal_Ds2pipipi_11.root",          "signal_Ds2pipipi_11_PID_tmp.root",  "MagDown_2011", "gen_MagDown",trackList[1],"Gen"), 
  ("signal_Ds2pipipi_11_PID_tmp.root", "signal_Ds2pipipi_11_PID_tmp2.root", "MagDown_2011", "corr_MagDown",trackList[1],"Corr"), 
  ("signal_Ds2pipipi_11_PID_tmp2.root", "signal_Ds2pipipi_11_PID.root",      "MagUp_2011",   "corr_MagUp",  trackList[1],"Corr"),
