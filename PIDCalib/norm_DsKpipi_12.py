...
files = [
  ...
  (indir+"norm_Ds2Kpipi_12.root",          "norm_Ds2Kpipi_12_PID_tmp.root",  "MagDown_2012", "gen_MagDown",trackList[5],"Gen"), 
  ("norm_Ds2Kpipi_12_PID_tmp.root", "norm_Ds2Kpipi_12_PID_tmp2.root", "MagDown_2012", "corr_MagDown",trackList[5],"Corr"), 
  ("norm_Ds2Kpipi_12_PID_tmp2.root", "norm_Ds2Kpipi_12_PID.root",      "MagUp_2012",   "corr_MagUp",  trackList[5],"Corr"),
