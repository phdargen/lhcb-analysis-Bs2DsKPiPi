...
files = [
  ...
  (indir+"norm_Ds2Kpipi_11.root",          "norm_Ds2Kpipi_11_PID_tmp.root",  "MagDown_2011", "gen_MagDown",trackList[5],"Gen"), 
  ("norm_Ds2Kpipi_11_PID_tmp.root", "norm_Ds2Kpipi_11_PID_tmp2.root", "MagDown_2011", "corr_MagDown",trackList[5],"Corr"), 
  ("norm_Ds2Kpipi_11_PID_tmp2.root", "norm_Ds2Kpipi_11_PID.root",      "MagUp_2011",   "corr_MagUp",  trackList[5],"Corr"),
