...
files = [
  ...
  (indir+"norm_Ds2Kpipi_16.root",          "norm_Ds2Kpipi_16_PID_tmp.root",  "MagDown_2016", "gen_MagDown",trackList[5],"Gen"), 
  ("norm_Ds2Kpipi_16_PID_tmp.root", "norm_Ds2Kpipi_16_PID_tmp2.root", "MagDown_2016", "corr_MagDown",trackList[5],"Corr"), 
  ("norm_Ds2Kpipi_16_PID_tmp2.root", "norm_Ds2Kpipi_16_PID.root",      "MagUp_2016",   "corr_MagUp",  trackList[5],"Corr"),
