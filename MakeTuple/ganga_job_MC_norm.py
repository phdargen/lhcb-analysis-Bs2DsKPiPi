...
j.application = myApp
j.application.options = ["b2dpipipi_17_MC_Up.py"]
j.backend=Dirac()
j.application.platform = "x86_64-slc6-gcc49-opt"
datatmp=BKQuery('/MC/2017/Beam6500GeV-2017-MagUp-Nu1.6-25ns-Pythia8/Sim09e/Trig0x62661709/Reco17/Turbo04a-WithTurcal/Stripping29r2Filtered/Merge14/13266068/B02D0HHH.STRIP.DST', dqflag=['OK']).getDataset()
...
myApp.directory = "./FT_new3/DaVinciDev_v42r7p2"
j.application = myApp
j.application.options = ["b2dpipipi_17_MC_Down.py"]
j.backend=Dirac()
j.application.platform = "x86_64-slc6-gcc49-opt"
datatmp=BKQuery('/MC/2017/Beam6500GeV-2017-MagDown-Nu1.6-25ns-Pythia8/Sim09e/Trig0x62661709/Reco17/Turbo04a-WithTurcal/Stripping29r2Filtered/Merge14/13266068/B02D0HHH.STRIP.DST', dqflag=['OK']).getDataset()
