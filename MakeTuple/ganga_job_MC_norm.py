...
j2=Job(name='N11UMC',application=DaVinci(version="v36r1"), backend=Dirac() )
j2.application.optsfile = [ 'b2d3pi_11_MC_Up.py' ]
j2.application.platform = "x86_64-slc6-gcc48-opt"
datatmp2=BKQuery('/MC/2011/Beam3500GeV-2011-MagUp-Nu2-Pythia8/Sim08i/Digi13/Trig0x40760037/Reco14c/Stripping21r1NoPrescalingFlagged/13266006/ALLSTREAMS.DST', dqflag=['OK']).getDataset()
...
j4=Job(name='N12UMC',application=DaVinci(version="v36r1"), backend=Dirac() )
j4.application.optsfile = [ 'b2d3pi_12_MC_Up.py' ]
j4.application.platform = "x86_64-slc6-gcc48-opt"
datatmp4=BKQuery('/MC/2012/Beam4000GeV-2012-MagUp-Nu2.5-Pythia8/Sim08i/Digi13/Trig0x409f0045/Reco14c/Stripping21NoPrescalingFlagged/13266006/ALLSTREAMS.DST', dqflag=['OK']).getDataset()
