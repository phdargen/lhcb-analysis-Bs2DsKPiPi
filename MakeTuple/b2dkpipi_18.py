...
Bs2DsXSel = FilterDesktop("Bs2DsXSel", Code = "(INTREE((ABSID=='D+')&(M>1888))) & (INTREE((ABSID=='D+')&(M<2048))) & (INTREE((ABSID=='B0')&(M>5100))) & (INTREE((ABSID=='B0')&(M<5900))) & (INTREE((ABSID=='K_1(1270)+')&(M<2100)))")
...
#IOHelper().inputFiles([
    #'../../00077434_00006187_1.bhadroncompleteevent.dst'
#], clear=True)
